...
const TESTIMONIALS = [
  {
    ...
    quote:
      "Students often make silly mistakes on their resume by using inconsistent bullet points or font sizes. CVForge's auto-formatting flow is a great help for keeping the document consistent.",
    name: "Ms. Spiegel",
    title: "Educator",
  },
  {
    ...
    quote:
      "I used CVForge during my last job search and was invited to interview at top tech companies such as Google and Amazon thanks to its slick yet professional resume design.",
    name: "Santi",
  ...
  },
  {
    ...
    quote:
      "Creating a professional resume on CVForge is smooth and easy. It saves me a lot of time and avoids the usual Google Docs template headaches.",
    name: "Vivian",
